...
#                         for i in range(10):
#                             try:
#                                 ser = serial.Serial('/dev/ttyACM'+str(i), baudrate=115200)
#                                 break
#                             except:
#                                 pass
#                     elif msg == 'stopSerial':
...
#                                                 PprevXY[ndx][0] = np.nan
#                                                 PprevXY[ndx][1] = np.nan
#                                 # print([sum(pellet_seen),sum(pellet_on_post),act_sel])
...
#                                 elif act_sel == 4:
#                                     if (time.time()-sys_timer) > 2 and pellet_seen:
#                                         act_sel = 5
#                                         rch_timer = [0,0,0,0,0]
#                                         if user_cfg['unitRef'] == 'unit05':
#                                             ser.write(b'Z')
