...
# Settting the GUI size and panels design
        ...
        if screenW > screenH:
            self.gui_size = (int(screenW*0.95),int(screenH*0.55))
...
# Spliting the frame into top and bottom panels. Bottom panels contains the widgets. The top panel is for showing images and plotting!
        ...
        if self.guiDim == 0:
            ...
            vSplitterA.SplitHorizontally(self.image_panel,vSplitter, sashPosition=int(self.gui_size[1]*0.5))
            vSplitterA.SetSashGravity(0.5)
            topSplitter.SplitVertically(vSplitterA, self.widget_panel,sashPosition=int(self.gui_size[0]*0.85))#0.9
